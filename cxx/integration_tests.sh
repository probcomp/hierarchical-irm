...
./bazel-bin/pclean/pclean --schema=assets/flights.schema --obs=assets/flights_dirty.csv --iters=5
./bazel-bin/pclean/pclean --schema=assets/hospitals.schema --obs=assets/hospitals_dirty.csv --iters=5
./bazel-bin/pclean/pclean --schema=assets/rents.schema --obs=assets/rents_dirty.csv --iters=5
