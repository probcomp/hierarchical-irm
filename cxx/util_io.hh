...
typedef std::tuple<std::string, std::vector<std::string>, T_column> T_observation;
...
void to_txt(const std::string &path, const IRM &irm, const T_encoding &encoding);
void to_txt(const std::string &path, const HIRM &irm, const T_encoding &encoding);
...
std::map<std::string, std::map<int, std::vector<std::string>>> load_clusters_irm(const std::string &path);
std::tuple<
    std::map<int, std::vector<std::string>>,                       // x[table] = {relation list}
    std::map<int, std::map<std::string, std::map<int, std::vector<std::string>>>> // x[table][domain][table] = {item list}
    >
